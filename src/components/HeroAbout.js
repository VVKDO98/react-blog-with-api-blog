...
const HeroAbout = () => {
    return (
        <div className='py-10 w-full flex flex-col items-center justify-center bg-bannercolor'>
            <div className='w-4/5 mx-auto text-justify flex flex-col items-center justify-center lg:w-3/5'>
            ...
            <div className='mt-10 w-4/5 mx-auto lg:mt-24'>
                ...
                <div className='w-full flex flex-row flex-wrap justify-between gap-10 lg:flex-nowrap lg:gap-0 lg:items-center'>
                    <img className='w-2/5 lg:w-1/6' src="./assets/img/wordpress.webp" alt="wordpress" />
                    <img className='w-2/5 lg:w-1/6' src="./assets/img/unsplash.webp" alt="unsplash" />
                    <img className='w-2/5 lg:w-1/6' src="./assets/img/medium.webp" alt="medium" />
                    <img className='w-2/5 lg:w-1/6' src="./assets/img/grammarly.webp" alt="grammarly" />
                    <img className='w-2/5 lg:w-1/6' src="./assets/img/blogger.webp" alt="blogger" />
                </div>
            </div>
        </div>
    );
