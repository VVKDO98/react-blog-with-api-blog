...
const MeetOurAuthors = () => {
    ...
    return (
        <div className='my-10 w-4/5 mx-auto flex flex-col'>
            <h1 className='mb-8 text-2xl text-justify text-black font-semibold'><span className='text-white bg-green py-0.5 px-2'>Meet</span> Our Authors</h1>
            <div>
                {data.map((authors) => {
                    return  <div className='mt-10 flex flex-row items-center gap-6'>
                                <div className='w-40 aspect-square bg-green flex justify-center items-center overflow-hidden'>
            ...
            <div className='mt-10 p-6 w-full bg-bannercolor flex flex-col items-center justify-center'>
